/* DADOS DO QUIZ — Interpretação de Texto (habilidades BNCC) */
const QUIZ_DADOS = {
  id: "bncc-interpretacao",
  titulo: "Interpretação de Texto — Habilidades BNCC",
  descricao: "8 questões de leitura alinhadas às habilidades de Língua Portuguesa da BNCC e do Currículo Referência de Minas Gerais.",
  tempoPorQuestao: 75,
  questoes: [
    ...
    { pergunta: "\"As alunas terminaram o cartaz. Elas o entregaram à diretora.\" — No segundo período, \"o\" substitui:",
      opcoes: ["O cartaz", "As alunas", "A diretora", "A escola"],
      correta: "O cartaz",
      explicacao: "Habilidade: coesão referencial. O pronome \"o\" retoma \"o cartaz\", evitando a repetição da palavra." },
    { pergunta: "Tese: \"A leitura diária melhora o desempenho escolar.\" — Qual argumento SUSTENTA essa tese?",
      opcoes: [
        ...
        "Os livros podem ser caros",
        "Há pessoas que preferem filmes"
      ],
      correta: "Pesquisas mostram que alunos que leem 30 min por dia tiram notas maiores",
      explicacao: "Habilidade: relação tese–argumento. Só a primeira opção apresenta evidência que comprova a afirmação defendida." },
    { pergunta: "\"Nóis vai junto\" é um exemplo de variedade linguística. A atitude adequada diante dessa fala é:",
      opcoes: [
      ...
      explicacao: "Habilidade: combater o preconceito linguístico. Toda variedade comunica; a escola amplia o repertório sem desvalorizar a fala de origem." },
    { pergunta: "\"O 'campeão' chegou por último de novo.\" — As aspas em \"campeão\" produzem efeito de:",
      opcoes: ["Ironia", "Citação de autor", "Destaque carinhoso", "Título oficial"],
      correta: "Ironia",
