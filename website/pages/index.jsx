...
const AREAS = [
  ...
  },
  {
    ...
    items: ["11 temas · 146 questões reais", "Simulados de 50 minutos", "Provas reais 2019–2025", "Gabarito comentado"],
...
const RECENTES = [
  { tag: "ENEM", tagColor: "#22D3EE", titulo: "Portal ENEM · Língua Portuguesa", desc: "11 temas, 146 questões reais com gabarito comentado e simulados de 50 min.", href: "/enem.html", img: "https://images.unsplash.com/photo-1518133835878-5a93cc3f89e5?auto=format&fit=crop&w=700&q=70", quando: "atualizado esta semana" },
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 relative" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 pb-20">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { icon: BookOpenCheck, val: "146", label: "Questões reais no Portal ENEM", color: "#22D3EE" },
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm">146 questões reais em 11 temas, com progresso salvo e gabarito comentado.</p>
            </div>
          </div>
